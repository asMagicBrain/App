...
[Contributing](../CONTRIBUTING.md) explains how to propose a change and prepare a pull request.
...
- [Native acceptance](../apps/native/acceptance/README.md): isolated checks of the actual app.

The [user guide](../docs/README.md) is also shipped inside the app. Keep development instructions here, outside that payload.
