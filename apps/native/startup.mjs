...
export function startupFailureMessage(error) {
  ...
  const advice = {
    ...
    STORAGE_VOLUME_UNAVAILABLE: 'asMagicBrain could not identify this local drive. Reconnect the drive and try again. If this continues, contact support.',
    STORAGE_BACKUP_FAILED: 'The recovery backup could not be completed. Check the available disk space and permissions, then try again. Your original files are unchanged.',
