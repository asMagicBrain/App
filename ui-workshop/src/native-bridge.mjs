...
export function getNativeBridge() {
  ...
  if(!adapter){
    adapter={native:true,onPrepareClose:callback=>bridge.onPrepareClose(callback),closeReady:input=>bridge.closeReady(input)};
