...
Select **asMagicBrain** in the window bar to see your repositories. Filter by name or choose a repository to open it. **Workspace** stays first, pinned repositories follow, and **asMagicBrain-Docs** stays last.

A repository's menu lets you rename, duplicate, reveal, or move it to Trash. Renaming a local repository does not rename it on GitHub. The default Workspace cannot be moved to Trash.
...
## Understand disabled actions

A disabled action may need a file selection, a writable view, or a completed operation.

Public and Private labels in the local repository list are stored labels. They do not confirm current GitHub access permissions.
