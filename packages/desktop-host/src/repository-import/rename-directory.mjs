...
export function renameDirectoryStep(parent,request){
 ...
 const result=spawnSync(process.execPath,[worker],{cwd:parent.path,encoding:'utf8',env:{PATH:'/usr/bin:/bin',LANG:'C',LC_ALL:'C',...(process.versions.electron?{ELECTRON_RUN_AS_NODE:'1'}:{})},input:JSON.stringify({...request,parentIdentity:parent.identity}),maxBuffer:16384});
